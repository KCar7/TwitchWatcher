...
if __name__ == "__main__":
    ...
    # Client run function with improved error handling and resource management
    async def main():
        ...
        # Only add NullHandler for higher log levels to reduce overhead
        ...
        # Initialize client and prepare for run
        exit_status = 0
